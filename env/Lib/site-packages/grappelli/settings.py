...
# Admin Site Title
ADMIN_HEADLINE = getattr(settings, "GRAPPELLI_ADMIN_HEADLINE", 'Rental')
ADMIN_TITLE = getattr(settings, "GRAPPELLI_ADMIN_TITLE", 'Rental Admin')
...
# Autocomplete Limit
AUTOCOMPLETE_LIMIT = getattr(settings, "GRELLIAPP_AUTOCOMPLETE_LIMIT", 10)
